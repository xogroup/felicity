...
class NumberExample extends Any {
    _generate(rules) {
        ...
        if (rules.min !== undefined || rules.greater !== undefined) {
            min = rules.min.limit !== undefined ? rules.min.limit : rules.greater + 1;
            lockMin = true;
        ...
        if (rules.max !== undefined || rules.less !== undefined) {
            max = rules.max !== undefined ? rules.max.limit : rules.less - 1;
            lockMax = true;
        }
