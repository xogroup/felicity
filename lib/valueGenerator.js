...
const string = function (schema, options) {
...
const number = function (schema, options) {
...
const object = function (schema, options) {
...
const alternatives = function (schema, options) {
